---
title: "R Notebook -  Analysis Immune + T cell category"
output:
  html_document:
    df_print: paged
---
...
surv <-c("Bcell_G","Neutrophil_G","Myeloid_G","CD4_G","CD8_G", "metacluster")
```
...
res.cox <- coxph(Surv(time, status) ~   Neutrophil+Bcell+CD4+CD8 + Myeloid + Stage+Grade+M.new, data =  surv_dat)
...
#OS survival
surv <-c("Bcell_G","Neutrophil_G","CD4_G","CD8_G","Myeloid_G", "metacluster")
...
surv <-c("Myeloid_G","Neutrophil_G","Bcell_G" ,"CD4_G","CD8_G","metacluster")
```
...
surv_dat$total_density <- rowSums(surv_dat[,2:6])
...
res.cox <- coxph(Surv(time, status) ~   Myeloid+ Bcell+ Neutrophil +CD4+CD8+ Stage+Grade+M.new, data =  surv_dat)
...
#Not split
#surv <-c("metacluster")
surv <-c("Neutrophil_G","Bcell_G","Myeloid_G","metacluster", "CD8_G","CD4_G","Density_G")
library(survminer)
...
surv <-c("Bcell_G","CD4_G","CD8_G","Myeloid_G","Neutrophil_G","Density_G","metacluster")
```
...
surv <-c("Bcell_G","Neutrophil_G","Myeloid_G","CD4_G","CD8_G","Density_G","metacluster")
...
tdat_wide$total_density <- rowSums(tdat_wide[,2:6])
tdat <-tdat_wide %>% pivot_longer(cols=c(colnames(tdat_wide[,2:7])), names_to = "Phenotype",values_to = "density")
